                      ...
                      <table className="min-w-full text-center text-sm font-light border-2 border-gray-400 rounded-xl">
                        <thead className="border-2 border-black font-medium dark:border-neutral-500 ">
                          <tr>
                            <th
                              scope="col"
                              className="px-6 py-4 font-bold text-[16px] tracking-wide"
                            >
                              Factors
                            </th>
                            <th
                        ...
                        <tbody>
                          <tr className="border-b dark:border-neutral-600 dark:bg-neutral-600">
                            <td className="whitespace-nowrap px-6 py-4 font-semibold tracking-wide dark:text-neutral-50">
                              Interest Rates
                            </td>
                            <td className="whitespace-nowrap px-6 py-4 font-bold dark:text-neutral-50 tracking-wide">
                              10.02%
                            </td>
                            <td className="whitespace-nowrap px-6 py-4 font-bold dark:text-neutral-50 tracking-wide">
                              12.20%
                          ...
                          <tr className="border-b border-secondary-200 bg-secondary-100 text-neutral-800">
                            <td className="whitespace-nowrap px-6 py-4 font-semibold tracking-wide">
                              Housing Assistance
                            </td>
                          ...
                          <tr className="border-b text-neutral-50 ">
                            <td className="whitespace-nowrap px-6 py-4 font-semibold tracking-wide text-black">
                              Career Guidance
                            </td>
                            <td className="px-6 py-4">
                              <div className="flex justify-center items-center">
                          ...
                          <tr className="border-b text-neutral-50 dark:border-neutral-600  dark:bg-neutral-600">
                            <td className="whitespace-nowrap px-6 py-4 font-semibold tracking-wide text-black dark:text-neutral-50">
                              Job Support
                            </td>
                            <td className="px-6 py-4">
                              <div className="flex justify-center items-center">
